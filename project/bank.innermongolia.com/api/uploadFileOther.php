...
$extensionList= array("xls","xlsx","jpeg","jpg","png","gif","wps","dps","et");
...
if ( !in_array($tmpExtensionName,$extensionList) )
{
    $retArr["retCode"]=0;
    $retArr["filePath"]="";
    $retArr["msg"]="只支持xls|xlsx|wps|dps|et|jpeg|jpg|png|gif文件类型的上传:".$tmpExtensionName;
...
else
{
    ...
    if ( $retEnd[0] === 'success' )
    {
        ...
        elseif  ( $tmpExtensionName == 'gd'|| $tmpExtensionName == 'wps'|| $tmpExtensionName == 'GW'|| $tmpExtensionName == 'jpg'|| $tmpExtensionName == 'png'|| $tmpExtensionName == 'jpeg'|| $tmpExtensionName == 'gif')
        {
