...
{
    return '<div class="title"><span><img src="images/leftico01.png" /></span>'.$menuName.'</div><ul class="menuson">';
}
...
if ($opt === "listFlag") {
    ...
    $GLOBAL['htmlDefine']['replaceArray']['__MENUBODY__']=$htmlStr.$tree_class->buildTreeHtml()."</ul></dd>";
